                    ...
                    <div class="card" style="border-radius: 15px;">
                      <div class="card-body p-5">
                        ...
                        <form>
                          ...
                          <div class="form-outline mb-4">
                            <input type="password" class="form-control form-control-lg" placeholder="Nhập Số Điện Thoại" style="font-size: 17px;" required name="phone_number"/>
                          </div>
          
                          <div class="form-outline mb-4">
                            <input type="password"  class="form-control form-control-lg" placeholder="Nhập Địa Chỉ" style="font-size: 17px;" required name="address"/>
                          </div>
                          <div class="form-outline mb-4">
                          ...
                          <p class="text-center text-muted mt-5 mb-0">Bạn đã có tài khoản? <a href="login.html" class="fw-bold text-infor" style="text-decoration: none;">Đăng Nhập tại đây</a></p>
