                            ...
                            @foreach($products_treem as $treem)
                                <div class="product_view-list-item colum-3">
                                    <div class="product_view-info">
                                        <img title="" src="{{ asset('img/'.$treem -> thumbnail) }}" alt="" class="product_view-info-img">
                                    ...
                                    <div class="proct_view-properties">Thời Trang treem</div>
                                    <div class="product_view-treeme"><b>{{$treem -> title}}</b></div>
                                    <div class="product_view-cost">
                                        <span class="product_view-cost-new">{{$treem -> price}}đ</span>
                                        <span class="product_view-cost-old">{{$treem -> discount}}đ</span>
                                    </div>
                                </div>
                            @endforeach
